...
<div class="row" style="width:1500 ; padding-left:500;padding-top:100">
  <div class="col-75">
    <div class="container">
      <form action="/action_page.php" name = "myForm" onsubmit="return validateForm()" method="post" required>
        ...
        <input type="submit" value="Continue to checkout" class="btn" onsubmit="return validateForm()">
      </form>
    </div>
  </div>
